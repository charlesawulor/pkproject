...
class logisticsmanagementController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'logisticsmanagement';
    ...
    {
        $grid = new Grid(new logisticsmanagement());
    ...
    {
        $show = new Show(logisticsmanagement::findOrFail($id));
    ...
    {
        $form = new Form(new logisticsmanagement());
