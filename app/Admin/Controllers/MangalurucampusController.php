...
class MangalurucampusController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'mangalurucampus';
    ...
    {
        $grid = new Grid(new mangalurucampus());
    ...
    {
        $show = new Show(mangalurucampus::findOrFail($id));
    ...
    {
        $form = new Form(new mangalurucampus());
