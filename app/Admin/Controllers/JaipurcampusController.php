...
class JaipurcampusController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new jaipurcampus());
    ...
    {
        $show = new Show(jaipurcampus::findOrFail($id));
    ...
    {
        $form = new Form(new jaipurcampus());
