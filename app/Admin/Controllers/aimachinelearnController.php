...
class aimachinelearnController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'aimachinelearn';
    ...
    {
        $grid = new Grid(new aimachinelearn());
    ...
    {
        $show = new Show(aimachinelearn::findOrFail($id));
    ...
    {
        $form = new Form(new aimachinelearn());
