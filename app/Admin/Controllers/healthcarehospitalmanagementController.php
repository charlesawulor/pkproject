...
class healthcarehospitalmanagementController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'healthcarehospitalmanagement';
    ...
    {
        $grid = new Grid(new healthcarehospitalmanagement());
    ...
    {
        $show = new Show(healthcarehospitalmanagement::findOrFail($id));
    ...
    {
        $form = new Form(new healthcarehospitalmanagement());
