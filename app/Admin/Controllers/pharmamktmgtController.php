...
class pharmamktmgtController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new pharmamktmgt());
    ...
    {
        $show = new Show(pharmamktmgt::findOrFail($id));
    ...
    {
        $form = new Form(new pharmamktmgt());
