...
class AnantapurcampusesController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'anantapurcampus';
    ...
    {
        $grid = new Grid(new anantapurcampus());
    ...
    {
        $show = new Show(anantapurcampus::findOrFail($id));
    ...
    {
        $form = new Form(new anantapurcampus());
