...
class DehraduncampusesController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'dehraduncampus';
    ...
    {
        $grid = new Grid(new dehraduncampus());
    ...
    {
        $show = new Show(dehraduncampus::findOrFail($id));
    ...
    {
        $form = new Form(new dehraduncampus());
