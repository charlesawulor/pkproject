...
class managementstudyController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'managementstudy';
    ...
    {
        $grid = new Grid(new managementstudy());
    ...
    {
        $show = new Show(managementstudy::findOrFail($id));
    ...
    {
        $form = new Form(new managementstudy());
